...
### B. Skills Existantes (Prompts IA)

Les prompts pour la génération de contenu s'appuient sur :
- `meta-ads-creative-generator` v5.0 (1038 lignes, méthodologie complète)
- `meta-ads-static-images-creator` v3.0 (génération prompts images)

Ces skills seront adaptés et intégrés dans `/lib/ai/prompts/`.
