# Principes Alen Sultanic - Fondation Stratégique

## Les 4 Besoins Humains Universels
...
- Réduction de risque ("essai gratuit", "sans engagement")
...
- Découverte ("secret", "méthode inconnue")
...
- Impact ("change la vie de", "fais la différence")
...
- Relations ("améliore tes relations avec")
...
**Concept Clé :** Les gens n'achètent pas des produits, ils achètent une transformation d'identité et une émotion.

### Composante 1 : L'Identité Visée
...
### Composante 2 : L'Émotion Déclenchée

**Les 4 émotions d'achat principales :**

1. **PEUR** (éviter la douleur, la perte)
   - Pain point agitation
   - Conséquences de l'inaction
   - "Ne fais pas cette erreur..."

2. **DÉSIR** (obtenir le plaisir, le gain)
   - Résultat aspirationnel
   - Future state painting
   - "Imagine si tu..."

3. **ESPOIR** (croire qu'un changement est possible)
   - Nouvelle solution
   - "Il existe une méthode..."
   - Mécanisme unique

4. **COLÈRE** (frustration envers le statu quo)
   - "En as-tu marre de..."
   - "Pourquoi personne ne te dit..."
   - Against-the-grain positioning

**Règle d'or :** Une bonne créative active 2 émotions (généralement PEUR + ESPOIR ou COLÈRE + DÉSIR)
...
**Exemple :** "Ce dispositif élimine les douleurs de dos en 5 minutes"

**Template recommandé :** Solution Exaggeration, Relatable Hook
...
**Exemple :** "Comme [concurrent connu], mais 2x plus rapide et sans effets secondaires"

**Template recommandé :** Simplified Us vs Them, The Minimal Us vs Them
...
**Exemple :** "Ce n'est pas un supplément, c'est une réinitialisation métabolique"

**Template recommandé :** This Is NOT [Product], "Stealing" Credibility
...
**Exemple :** "Pour les mamans de 15 ans qui en ont marre de [pain point spécifique]"

**Template recommandé :** Avatar Callout, Indirect Avatar, Specific Pain Point
...
**Exemple :** "Pour ceux qui ne se contentent pas du standard"

**Template recommandé :** Classy Offer, Pubity Style

---

## Tradeoffs (Sacrifices vs Gains)

**Concept :** Tout achat implique un sacrifice (temps, argent, effort, autre priorité). Les créatives performantes reconnaissent le sacrifice ET amplifient le gain.

### Structure Tradeoff en 3 Étapes

**Étape 1 : Reconnaître le Sacrifice**
...
En échange ? [Liste des gains concrets].
(amplification)
...
## Checklist Stratégique Alen Sultanic

Avant de générer des créatives, réponds à ces questions :

- [ ] Quel(s) besoin(s) humain(s) mon offre satisfait-elle ? (Sécurité, Variété, Importance, Connection)
- [ ] Quelle identité mon avatar veut-il/elle devenir en achetant ?
- [ ] Quelle(s) émotion(s) je veux activer ? (Peur, Désir, Espoir, Colère)
- [ ] À quel niveau de sophistication est mon marché ? (1-5)
- [ ] Quel est le tradeoff (sacrifice vs gain) de mon offre ?
- [ ] Comment puis-je reframe le sacrifice pour le minimiser ?
- [ ] Comment puis-je amplifier le gain pour le rendre irrésistible ?

Si tu ne peux pas répondre à ces questions, tu n'as pas assez d'informations pour créer des créatives performantes.
