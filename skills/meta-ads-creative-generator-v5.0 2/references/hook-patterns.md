# Hook Patterns - Formules de Headlines Gagnantes

Les hooks sont la partie la plus critique de tes créatives. Un mauvais hook = scroll immédiat. Un bon hook = curiosity gap qui force le clic/lecture.

---

## Les 6 Patterns Éprouvés
...
- "8 Heures. Sommeil profond retrouvé."
- "48H. Livré chez toi."
...
**Règles :**
✅ Outcome doit être SPÉCIFIQUE (pas "mieux dormir", mais "sommeil profond")  
✅ Timeline doit être crédible pour le résultat promis  
✅ Utilise "+" pour indiquer durabilité ("14+ hours" > "14 hours")

---

### 2. THIS IS X, THIS IS Y
...
**Règles :**
✅ X doit être universellement connu  
✅ Y doit être désirable/aspirationnel  
...
- "100% naturel. 0% effets secondaires."
...
**Règles :**
✅ Les pourcentages doivent être vrais (ou très défendables)  
✅ Contraste doit être significatif (pas "90% vs 95%")  
...
### 4. MINIMAL CHANGE, MAXIMUM IMPACT
...
- "Pas besoin de refaire ta garde-robe. Change juste ça."
...
**Règles :**
✅ Le "minimal change" doit être VRAIMENT minimal  
✅ Le "maximum impact" doit être crédible  
...
**Règles :**
✅ SPÉCIFICITÉ > tout. "Moms" < "Moms of teens" < "Moms of 15 year olds"  
✅ Utilise le langage de l'avatar (comment ils se décrivent eux-mêmes)  
...
**Erreurs à éviter :**
❌ "Femmes 25-45" (trop large)  
❌ "Personnes qui veulent être en forme" (pas spécifique)  
❌ Jargon que l'avatar n'utilise pas ("B2B SaaS founders" si ils disent "entrepreneurs tech")
...
- "Résultats visibles aujourd'hui. Transformation en 90 jours."
...
**Règles :**
✅ Court-terme doit être quasi-immédiat (minutes, heures, jours)  
✅ Long-terme doit être transformation significative  
...
Tu peux (et devrais) combiner certains patterns pour plus d'impact.
...
❌ Dual Timeline + Percentage (trop de chiffres, confusing)  
❌ Avatar Callout + This is X/Y (message dilué)  
❌ 3+ patterns ensemble (overload)

---

## Anatomie d'un Hook Gagnant
...
✅ "Perd 2 kilos cette semaine" (crédible)  
✅ "J'ai accidentellement perdu 12 kilos à 52 ans" (énorme mais storytelling rend crédible)
...
Avant de valider un hook, vérifie :

- [ ] Scroll-stopper ? (Est-ce que ça arrête le pouce ?)
- [ ] Spécifique ? (Chiffres, timeframes, détails précis ?)
- [ ] Relevant ? (L'avatar se sent concerné immédiatement ?)
- [ ] Crédible ? (La promesse est défendable ?)
- [ ] Curiosity gap ? (Ça crée une question dans l'esprit ?)
- [ ] Court ? (Max 10 mots ?)
- [ ] Langage avatar ? (Mots qu'ils utilisent réellement ?)
- [ ] Pattern recognition ? (Utilise un des 6 patterns ?)

Si < 6/8 → Rewording nécessaire.
